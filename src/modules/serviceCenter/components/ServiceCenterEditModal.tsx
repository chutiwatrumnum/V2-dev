          ...
          ConfirmModal({
            ...
            onOk: async () => {
              try {
                ...
                const result = await mutationEditServiceCenter.mutateAsync(
                  payload
                );
          ...
          <div className="announceModalContainer">
            ...
            <div className="announceModalColumn">
              ...
              <ServiceImageGallery
                ...
                imageStatusId={Number(currentStatus.value!)}
                serviceId={data?.id!!}
              />
              ...
              <ServiceImageGallery
                ...
                maximum={3}
                disabledUpload={
                  currentStatus.label === "Repairing" ? false : true
                }
              ...
              <ServiceImageGallery
                ...
                maximum={3}
                disabledUpload={
                  currentStatus.label === "Success" ? false : true
                }
            ...
            {/* Column 2: Status & Problem Details */}
            <div className="announceModalColumn">
              <Form.Item<ServiceCenterDataType>
                label="Status"
                name="statusName"
