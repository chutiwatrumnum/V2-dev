...
import { ServiceCenterDataType, ServiceCenterSelectListType } from "../../../stores/interfaces/ServiceCenter";
...
const serviceCenterChatManage = ({ chatData }: { chatData?: ChatListDataType }) => {
    ...
    const { data, isLoading,refetch: refetchServiceCenter } = useServiceCenterByServiceIDQuery(chatData?.serviceId!);
    const onEditCancel = () => {
                ...
                <div className="sidebarContainer">
                    ...
                    <div className="detailContainer">
                        <div className="detailItem">
                            ...
                            <p>
                                Status: <Tag color={tagColorSelector(data?.statusName!)}>{data?.statusName}</Tag>
                            </p>
                        </div>
                    </div>
                    <Button disabled={data.statusName === "Success" ? true : false} onClick={() => onEdit()} size="large" shape="round">
                        <b>Manage</b>
                    </Button>
                </div>
