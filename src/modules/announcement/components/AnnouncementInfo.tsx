        ...
        <Row className="announcementInfoRow" justify={"space-between"}>
          <div className="announcementInfoColumn">
            <Space
              ...
              size="small"
              style={{ display: "flex" }}>
              <h4 className="announcementInfoTitle">Image</h4>
              <Image
          ...
          <div className="announcementInfoColumn">
            <h4 className="announcementInfoTitle">Title</h4>
            <p>{data.title}</p>
            <h4 className="announcementInfoTitle">Description</h4>
            <p>{data.description}</p>
            <Row justify={"space-between"}>
              <div className="announcementInfoDetailsColumn">
                <h4 className="announcementInfoTitle">Created date</h4>
                <p>{dayjs(data.createdAt).format("DD/MM/YYYY")}</p>
              </div>
              <div className="announcementInfoDetailsColumn">
                <h4 className="announcementInfoTitle">Created by</h4>
                <p>{`${data.createBy?.firstName} ${data.createBy?.middleName} ${data.createBy?.lastName}`}</p>
              </div>
              <div className="announcementInfoDetailsColumn">
                <h4 className="announcementInfoTitle">Start date/Time</h4>
                <p>{dayjs(data.startDate).format("DD/MM/YYYY : HH:mm")}</p>
              </div>
              <div className="announcementInfoDetailsColumn">
                <h4 className="announcementInfoTitle">End date/Time</h4>
                <p>{dayjs(data.endDate).format("DD/MM/YYYY : HH:mm")}</p>
              </div>
            </Row>
            <h4 className="announcementInfoTitle">Status</h4>
            <p>
