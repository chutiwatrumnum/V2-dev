...
const CreateParticipantGroup = (props: ComponentCreateProps) => {
  ...
  const onFinish = async (values: any) => {
    confirm({
      ...
      icon: null,
      content: "Are you sure you want to create participant group?",
      okText: "Yes",
      okType: "primary",
      cancelText: "Cancel",
      centered: true,
      ...
      async onOk() {
        const request: ParticipantGroup = {
          groupName: values.groupName,
          email: tags,
        };

        const reultCreated = await addParticipantGroup(request);
        if (reultCreated) {
              ...
              <Form.Item
                ...
                {inputVisible ? (
                  ...
                  <Tag onClick={showInput} style={tagPlusStyle}>
                    <PlusOutlined style={{ width: 8 }} /> New email
                  </Tag>
                )}
              </Form.Item>
            </Col>
